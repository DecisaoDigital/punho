...
/**
 * Instala um APK a partir do próprio Punho, sem passar pelo browser.
 *
 * Antes disto o botão do banner abria o URL no browser e o utilizador percorria
    ...
    fun instalar(context: Context, caminho: String, resultado: MethodChannel.Result) {
        ...
        try {
            instalador.openSession(sessaoId).use { sessao ->
                ...
                sessao.openWrite("punho.apk", 0, ficheiro.length()).use { destino ->
